...
station_folder <- "FullScale/Labels/FilteredStationLocationsPerYear"  # Folder with station shapefiles
road_file <- "TestRun(Tampa)/Segments/Roads.shp"         # Road shapefile
buffer_miles <- 5
...
# Save to CSV
write.csv(results, "GCN_RoadLabels_2yr.csv", row.names = FALSE)
